...
def makexml(txtPath,xmlPath,picPath): #读取txt路径，xml保存路径，数据集图片所在路径
    dict = {'0.0': "holothurian",#字典对类型进行转换
            '1.0': "echinus",
            '2.0': "scallop",
            '3.0': "starfish"}
...
makexml("/DATA/zhanghui/underwater-obj_de/change_json/","/DATA/zhanghui/underwater-obj_de/change_xml/","/DATA/zhanghui/underwater-obj_de/data/test-A-image/")