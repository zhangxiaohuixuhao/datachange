...
def main():
    xml_path = '/DATA/zhanghui/underwater-objection-detection/data/train/box'
    img_path = '/DATA/zhanghui/underwater-objection-detection/data/train/image'
    print('processing {} ...'.format("xml format annotations"))
    cvt_annotations(img_path, xml_path, '/DATA/zhanghui/underwater-objection-detection/data/train/annotations/train.json')
    print('Done!')
