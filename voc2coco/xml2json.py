...
# PRE_DEFINE_CATEGORIES = {'Along_Double_Yellow_Lines': 1, 'Parallel_Parking': 2,
#                         'Against_Single_Centre_White_Line':3, 'On_Painted_Island_Chevron_Lines': 4,
#                         'Abreast_Double_Parking': 5, 'Against_Traffic_Two_Way_Street': 6, 'Heavy_Vehicle_In_Car_Lot': 7,
#                         'On_Single_Yellow_Line': 8, 'Against_Traffic_One_Way_Street': 9,
#                         'On_Zig_Zag_Lines': 10, 'Motorcycle_in_Car_Lot': 11, 'On_Pavement_DYL': 12, 'Car': 13, 'Motorcycle': 14, 'Truck': 15}

PRE_DEFINE_CATEGORIES = {'head_shoulder': 1}
# PRE_DEFINE_CATEGORIES = {'head_shoulder': 1}
def get(root, name):
...
if __name__ == '__main__':
    folder_list = ["trainval", "minival"]
    # 注意更改base_dir为本地实际图像和标注文件路径
    base_dir = "/DATA/zh_1210/yolo/"
    for i in range(2):
